    ...
    return (
        <div className="fixed inset-0 z-[300] flex items-end sm:items-center justify-center">
            ...
            <div
                ...
                className="relative w-full sm:w-[440px] max-h-[92vh] overflow-y-auto bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-t-3xl sm:rounded-2xl shadow-xl p-6 sm:p-8"
            >
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-1.5">University</label>
                        <UniversitySearch
                            value={institute}
