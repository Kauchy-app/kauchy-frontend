        ...
        <main className="relative min-h-[calc(100dvh-135px)] md:min-h-screen chat-bg overflow-hidden">
            <div className="relative max-w-[640px] mx-auto px-4 py-6 sm:py-8 flex flex-col gap-5">
                ...
                <div className="relative rounded-2xl overflow-hidden border border-black/5 dark:border-white/10 bg-white/70 dark:bg-white/[0.04] backdrop-blur-xl shadow-sm">
                    <div className="h-24 bg-gradient-to-r from-blue-500 via-violet-500 to-blue-500 relative">
                    ...
                    <div className="relative z-10 px-6 pb-6 -mt-12 flex flex-col items-center text-center">
                        <div className="w-24 h-24 rounded-full overflow-hidden ring-4 ring-white dark:ring-zinc-900 bg-zinc-100 dark:bg-zinc-800 shadow-md">
                            <Image src={avatar} alt={username} width={96} height={96} className="w-full h-full object-cover" />
                        </div>
                        <h1 className="mt-3 text-xl font-bold text-zinc-900 dark:text-white">{username}</h1>
                        {role && (
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-2xl border border-black/5 dark:border-white/10 bg-white/60 dark:bg-white/[0.04] backdrop-blur-xl p-4 text-center">
                        ...
                        <p className="mt-1.5 text-xs font-medium text-zinc-500 dark:text-zinc-400">Orders</p>
                    </div>
                    <div className="rounded-2xl border border-black/5 dark:border-white/10 bg-white/60 dark:bg-white/[0.04] backdrop-blur-xl p-4 text-center">
                        <p className="text-2xl font-bold text-zinc-900 dark:text-white leading-none">
                            {formatNairaFixed(walletBalance)}
                        </p>
                        <p className="mt-1.5 text-xs font-medium text-zinc-500 dark:text-zinc-400">Balance</p>
                    </div>
                </div>
                ...
                <Link
                    href="/wallet"
                    className="group flex items-center justify-between p-4 rounded-2xl bg-gradient-to-r from-amber-400 to-amber-500 text-white shadow-sm hover:shadow-md hover:shadow-amber-500/25 transition-all"
                >
                ...
                <div className="rounded-2xl border border-black/5 dark:border-white/10 bg-white/60 dark:bg-white/[0.04] backdrop-blur-xl overflow-hidden">
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-sm font-semibold text-zinc-800 dark:text-zinc-100">{l.label}</p>
                                    <p className="text-xs text-zinc-500 dark:text-zinc-400 truncate">{l.sub}</p>
                                </div>
                    ...
                    <div className="flex items-center gap-3.5 px-4 py-3.5 border-t border-black/5 dark:border-white/[0.08]">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-sm font-semibold text-zinc-800 dark:text-zinc-100">Dark Mode</p>
                            <p className="text-xs text-zinc-500 dark:text-zinc-400 truncate">Switch the app appearance</p>
                        </div>
                        {mounted && (
                            <button
