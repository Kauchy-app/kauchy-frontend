        ...
        <div className="min-h-screen w-full flex bg-[#FDFDFD] dark:bg-[#0A0A0A] font-sans overflow-hidden">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 sm:p-12 lg:p-20 relative overflow-y-auto z-10">
                <div className="w-full max-w-[440px] animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <div className="mb-10">
                        <h1 className="text-[2.2rem] leading-[1.2] font-serif tracking-tight text-zinc-900 dark:text-white mb-3">
                    ...
                    <form onSubmit={step === 4 ? handleSignupSubmit : step === 5 ? handleLoginSubmit : (e) => { e.preventDefault(); if (step === 1) checkEmail(); else if (step === 1.5) verifyOTP(); else nextStep(); }} className="space-y-6">
                        ...
                        {step === 1 && (
                            <div className="space-y-6 animate-in slide-in-from-right-8 fade-in duration-500">
                                ...
                                <button type="button" onClick={checkEmail} className="w-full flex items-center justify-center gap-2 py-4 px-6 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-xl text-base font-semibold cursor-pointer transition-all duration-300 hover:opacity-90 hover:-translate-y-0.5 hover:shadow-md" disabled={loading}>
                                    {loading ? (
                                        <span className="w-5 h-5 border-2 border-white/30 border-t-white dark:border-zinc-900/30 dark:border-t-zinc-900 rounded-full animate-spin"></span>
                                    ) : (
                                ...
                                <div className="flex items-center gap-4 py-2">
                                    ...
                                    <span className="text-[11px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">or</span>
                                    <span className="flex-1 h-px bg-zinc-200 dark:bg-zinc-800" />
                                </div>
                        ...
                        {step === 1.5 && (
                            <div className="space-y-6 animate-in slide-in-from-right-8 fade-in duration-500">
                                ...
                                <div className="flex gap-4 pt-2">
                                    <button type="button" onClick={prevStep} className="flex items-center justify-center py-4 px-5 bg-zinc-100 dark:bg-zinc-900 text-zinc-700 dark:text-zinc-300 rounded-xl font-semibold transition-colors hover:bg-zinc-200 dark:hover:bg-zinc-800">
                                        <ArrowLeft size={20} />
                                    </button>
                                    <button type="button" onClick={() => verifyOTP()} className="flex-1 flex items-center justify-center gap-2 py-4 px-6 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-xl text-base font-semibold transition-all hover:opacity-90 hover:-translate-y-0.5 hover:shadow-md" disabled={loading}>
                                        {loading ? (
                                            <span className="w-5 h-5 border-2 border-white/30 border-t-white dark:border-zinc-900/30 dark:border-t-zinc-900 rounded-full animate-spin"></span>
                                        ) : (
                                ...
                                <div className="text-center mt-4">
                                    <button type="button" onClick={checkEmail} className="text-sm text-zinc-500 hover:text-blue-600 dark:hover:text-blue-400 font-medium" disabled={loading}>
                                        Resend Code
                                    </button>
                                </div>
                            </div>
                        ...
                        {step === 2 && (
                            <div className="space-y-6 animate-in slide-in-from-right-8 fade-in duration-500">
                                ...
                                <div className="flex gap-4 pt-2">
                                    ...
                                    <button type="button" onClick={nextStep} className="flex-1 py-4 px-6 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-xl text-base font-semibold transition-all hover:opacity-90 hover:-translate-y-0.5">
                                        Continue
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="space-y-6 animate-in slide-in-from-right-8 fade-in duration-500">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <button
                                            type="button"
                                            className="absolute right-3 top-1/2 -translate-y-1/2 bg-transparent border-none text-zinc-500 dark:text-zinc-400 text-xs font-bold tracking-wide px-2 py-1.5 rounded-lg hover:text-zinc-900 dark:hover:text-white"
                                ...
                                <div className="flex gap-4 pt-2">
                                    <button type="button" onClick={prevStep} className="flex items-center justify-center py-4 px-5 bg-zinc-100 dark:bg-zinc-900 text-zinc-700 dark:text-zinc-300 rounded-xl font-semibold transition-colors hover:bg-zinc-200 dark:hover:bg-zinc-800" disabled={loading}>
                                        <ArrowLeft size={20} />
                                    </button>
                        ...
                        {step === 5 && (
                            <div className="space-y-6 animate-in slide-in-from-right-8 fade-in duration-500">
                                <div className="flex items-center justify-between p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700/50">
            ...
            <div className="hidden lg:block lg:w-1/2 p-4 pl-0">
                <div className="w-full h-full relative rounded-2xl overflow-hidden bg-zinc-900 shadow-xl shadow-black/20">
                    <Image 
